...
from lp.testing import BrowserTestCase, TestCaseWithFactory, login_celebrity
...
class TestSignedCodeOfConductAckView(TestCaseWithFactory):
    ...
    def test_view_properties(self):
        ...
        self.assertEqual("Register a code of conduct signature", view.label)
    ...
    def test_register_coc_signed_on_paper(self):
        ...
        view = create_initialized_view(
            self.signed_coc_set, name="+new", form=form, principal=self.admin
        )
...
class SignCodeOfConductTestCase(TestCaseWithFactory):
    ...
    def sign_coc(self, user, gpg_key):
        ...
        signed_coc = SignedCodeOfConduct(
            owner=user,
            signing_key_fingerprint=gpg_key.fingerprint,
            signedcode="Dummy CoC signed text.",
            active=True,
        )
        return signed_coc
    ...
    def verify_common_view_properties(self, view):
        ...
        self.assertEqual(view.page_title, view.label)
    ...
    def verify_admincomment_required(self, action_name, view_name):
        ...
        view = create_initialized_view(
            self.signed_coc, name=view_name, form=form, principal=self.admin
        )
...
class TestSignedCodeOfConductActiveView(SignCodeOfConductTestCase):
    def test_view_properties(self):
        ...
        self.assertEqual("Activate code of conduct signature", view.label)
    ...
    def test_activate(self):
        ...
        view = create_initialized_view(
            self.signed_coc, name="+activate", form=form, principal=self.admin
        )
        self.assertEqual([], view.errors)
        self.assertTrue(self.signed_coc.active)
        self.assertEqual(self.admin, self.signed_coc.recipient)
        self.assertEqual("The user is sorry.", self.signed_coc.admincomment)
...
class TestSignedCodeOfConductDeactiveView(SignCodeOfConductTestCase):
    def test_view_properties(self):
        ...
        self.assertEqual("Deactivate code of conduct signature", view.label)
    ...
    def test_deactivate(self):
        ...
        self.assertEqual("The user is bad.", self.signed_coc.admincomment)

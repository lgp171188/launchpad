...
from lp.services.fields import ContentNameField, PersonChoice
...
class IProductReleaseFile(
    IProductReleaseFileEditRestricted, IProductReleaseFilePublic
):
...
class IProductReleaseView(Interface):
    ...
    datereleased = exported(
        Datetime(
            title=_("Date released"),
            required=True,
            readonly=False,
            description=_(
                "The date this release was published. Before "
    ...
    release_notes = exported(
        Text(
            ...
            required=False,
            description=_(
                "A description of important new features "
    ...
    displayname = exported(
        Text(
            title="Constructed display name for a project release.",
            readonly=True,
        ),
    ...
    product = exported(
        Reference(
            title="The project that made this release.",
            schema=Interface,
            readonly=True,
        ),
        exported_as="project",
    ...
    milestone = exported(
        ReferenceChoice(
            ...
            description=_(
                "A release requires a corresponding milestone "
...
class IProductRelease(
    IProductReleaseEditRestricted, IProductReleaseView, IProductReleasePublic
):
...
class IProductReleaseFileAddForm(Interface):
    ...
    signature = Bytes(
        title="GPG signature (recommended)",
        required=False,
        constraint=productrelease_signature_size_constraint,
    )

    contenttype = Choice(
        title=_("File content type"),
        required=True,
        vocabulary=UpstreamFileType,
        default=UpstreamFileType.CODETARBALL,
    )

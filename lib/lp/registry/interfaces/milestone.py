...
class IMilestoneData(
    IHasBugs, IStructuralSubscriptionTarget, IHasOfficialBugTags
):
...
class IAbstractMilestone(IMilestoneData):
    ...
    @export_factory_operation(
        IProductRelease, ["datereleased", "changelog", "release_notes"]
    )
    @operation_for_version("beta")
    def createProductRelease(
        owner, datereleased, changelog=None, release_notes=None
    ):

...
from storm.expr import And, Exists, Select
...
from lp.registry.model.milestone import Milestone, MilestoneData
...
def validate_tags(tags):
    ...
    return all(valid_name(tag) for tag in tags) and len(set(tags)) == len(tags)

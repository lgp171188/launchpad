...
from lp.testing import TestCaseWithFactory, launchpadlib_for, login
...
class ProjectMilestoneTest(unittest.TestCase):
    ...
    def _createProductSeriesBugtask(
        self, product_name, product_series_name, milestone_name
    ):

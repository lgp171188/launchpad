...
class SpriteUtil:
    ...
    def _loadCSSTemplate(
        self, css_template_file, group_name, url_prefix_substitutions=None
    ):
        """See `__init__`."""
        smartsprites_exp = re.compile(r"/\*+([^*]*sprite-ref: [^*]*)\*/")
    ...
    def combineImages(self, css_dir):
        ...
        combined_image_height = total_sprite_height + (
            self.margin * len(self.sprite_info) - 1
        )
        transparent = (0, 0, 0, 0)

...
class TestTag(TestCase):
    ...
    def test_too_short(self):
        ...
        self.assertRaises(ConstraintNotSatisfied, self.field.validate, "")
        self.assertRaises(ConstraintNotSatisfied, self.field.validate, "x")
    ...
    def test_invalid_characters(self):
        ...
        self.assertRaises(
            ConstraintNotSatisfied, self.field.validate, "char^not^allowed"
        )
        self.assertRaises(
            ConstraintNotSatisfied, self.field.validate, "no whitespace"
        )
        self.assertRaises(
            ConstraintNotSatisfied, self.field.validate, "really\no-whitespace"
        )

    def test_negated_search_form(self):
        # Tag rejects tags beginning with minuses. This form is
        # reserved to mean "not <tag>".
        self.assertRaises(ConstraintNotSatisfied, self.field.validate, "-fred")
...
class TestSearchTag(TestTag):
    ...
    def test_wildcard_elsewhere(self):
        ...
        self.assertRaises(
            ConstraintNotSatisfied, self.field.validate, "sn*t-allowed"
        )

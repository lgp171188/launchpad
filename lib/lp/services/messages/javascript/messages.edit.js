...
YUI.add('lp.services.messages.edit', function(Y) {
    ...
    module.fillMessageRevisions = function(elements, revisions) {
        ...
        revisions.forEach(function(rev) {
            content += Y.Lang.sub(template, rev);
        });
    ...
    module.onLastEditClick = function(elements, baseurl) {
        ...
        // Should do a request first...
        module.fillMessageRevisions(elements, [
            {sequence: 3, content: 'blabla', date: '2015-01-10 12:15'},
            {sequence: 2, content: 'fooo', date: '2015-01-10 12:11'},
            {sequence: 1, content: 'bla', date: '2015-01-10 12:13'}
        ])
    };

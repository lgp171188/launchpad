...
def _update_profile_stats(cls, func, duration):
    """Update the profile statistics with new information about a call."""
    global _profile_stats_filename
...
def report_profile_stats():
    ...
    for key, value in sorted(stats.items()):
        ...
        print("%-45s %4d calls taking %s." % (key[:45], hits, duration))

    print()
    print(
        "Total duration of profiled methods %0.1f seconds."
    ...
    print()
    print(
        "Total duration of test run %0.1f seconds."

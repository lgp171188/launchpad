...
from lp.testing.fixture import CaptureTimeline, ZopeUtilityFixture
...
class TestMailController(TestCase):
    ...
    def test_constructor2(self):
        ...
        self.assertEqual(["to1@example.com", "to2@example.com"], ctrl.to_addrs)
    ...
    def test_addAttachment(self):
        ...
        self.assertEqual(b"content1", attachment.get_payload(decode=True))
        ctrl.addAttachment(
        ...
        self.assertEqual(b"content2", attachment.get_payload(decode=True))
        ctrl.addAttachment(
            "content2", "text/plain", inline=True, filename="name1"
        )
    ...
    def test_MakeMessageSpecialChars(self):
        ...
        self.assertEqual(
            "=?utf-8?b?4YSAZnJvbUBleGFtcGxlLmNvbQ==?=", message["From"]
        )

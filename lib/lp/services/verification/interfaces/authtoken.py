...
class IAuthToken(Interface):
    ...
    date_created = Datetime(
        title=_("The timestamp that this request was made."),
        required=True,
    )
    ...
    tokentype = Choice(
        title=_("The type of request."),
        required=True,
        vocabulary=LoginTokenType,
    )
    token = Text(
        title=_(
            "The token (not the URL) emailed used to uniquely identify "
            "this request."
        ),
        required=True,
    )
    ...
    requester = Int(
        title=_("The Person that made this request."),
        required=True,
    )
    requesteremail = Text(
        title=_(
            "The email address that was used to login when making this "
            "request."
        ),
        required=False,
    )
    ...
    redirection_url = Text(
        title=_(
            "The URL to where we should redirect the user after "

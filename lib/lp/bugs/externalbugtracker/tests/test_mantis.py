...
from lp.bugs.externalbugtracker.mantis import Mantis, MantisBugBatchParser
...
class TestMantisBugBatchParser(TestCase):
    ...
    def test_empty(self):
        ...
        self.assertThat(str(exc), Equals("Missing header line"))
    ...
    def test_missing_headers(self):
        ...
        self.assertThat(
            str(exc),
            Equals(
                "CSV header ['some', 'headers'] missing fields:"
    ...
    def test_missing_some_headers(self):
        ...
        self.assertThat(
            str(exc),
            Equals(
                "CSV header ['some', 'headers', 'status', 'resolution'] "
                "missing fields: ['id']"
            ),
        )
    ...
    def test_passing(self):
        ...
        bug_13 = dict(id=13, status="confirmed", resolution="", ignored="boo")

...
class TestBugNotificationRecipients(TestCaseWithFactory):
    ...
    def test_public_bug(self):
        ...
        self.assertContentEqual([bug.owner], self.getFreshRecipients(bug))
    ...
    def test_public_bug_with_duplicate_subscriber(self):
        ...
        self.assertContentEqual(
            [bug.owner, dupe.owner, subscriber], self.getFreshRecipients(bug)
        )
    ...
    def test_private_bug(self):
        ...
        with person_logged_in(owner):
            self.assertContentEqual([owner], self.getFreshRecipients(bug))

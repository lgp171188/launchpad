...
class TestProductBugConfigurationView(TestCaseWithFactory):
    ...
    def setUp(self):
        ...
        self.product = self.factory.makeProduct(
            name="boing", owner=self.owner, bug_supervisor=self.bug_supervisor
        )
    ...
    def test_all_data_change(self):
        ...
        self.assertEqual(
            ServiceUsage.LAUNCHPAD, self.product.bug_tracking_usage
        )
    ...
    def test_bug_role_non_admin_can_edit(self):
        ...
        owning_team = self.factory.makeTeam(
            owner=self.owner, membership_policy=TeamMembershipPolicy.RESTRICTED
        )

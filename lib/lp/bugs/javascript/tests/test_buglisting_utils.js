...
var running_in_webkit = function() {
    ...
    // AppleWebKit/535 is Chromium 13-17 in Lucid-Oneiric.
    // AppleWebKit/538 is the html5 test browser in (at least) Trusty-Xenial.
    return (/AppleWebKit.53[1578]/).test(navigator.userAgent);
};

...
class RemoteBugUpdaterTestCase(TestCaseWithFactory):
    ...
    def test_create(self):
        ...
        updater = self.makeUpdater(
            remote_system, remote_bug_id, bug_watch_ids, unmodified_remote_ids
        )
        self.assertTrue(
    ...
    def test_convertRemoteImportance_logs_unknown_values(self):
        ...
        self.assertEqual(
            BugTaskImportance.UNKNOWN, updater._convertRemoteImportance("spam")
        )
        self.assertEqual(

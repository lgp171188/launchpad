...
from zope.schema import Bool, Choice, Datetime, FrozenSet, Int, Text
...
from lp.services.fields import PersonChoice, SearchTag
...
class IBugSubscriptionFilterAttributes(Interface):
    ...
    include_any_tags = Bool(
        title=_("Include any tags"), required=True, default=False
    )
    exclude_any_tags = Bool(
        title=_("Exclude all tags"), required=True, default=False
    )
    ...
    description = exported(
        Text(title=_("A short description of this filter"), required=False)
    )
    ...
    statuses = exported(
        FrozenSet(
            ...
            required=True,
            default=frozenset(),
            value_type=Choice(title=_("Status"), vocabulary=BugTaskStatus),
        )
    )
...
class IBugSubscriptionFilter(
    IBugSubscriptionFilterAttributes,
    IBugSubscriptionFilterMethodsProtected,

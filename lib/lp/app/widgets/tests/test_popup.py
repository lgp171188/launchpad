...
class TestVocabularyPickerWidget(TestCaseWithFactory):
    ...
    def test_widget_template_properties(self):
        ...
        self.assertEqual(
            self.vocabulary.step_title, widget_config["step_title"]
        )
        self.assertEqual(
            "show-widget-field-test_valid-item", picker_widget.show_widget_id
        )
        self.assertEqual("field.test_valid.item", picker_widget.input_id)
    ...
    def test_widget_personvalue_meta(self):
        ...
        self.assertEqual(
            "person", person_picker_widget.config["selected_value_metadata"]
        )

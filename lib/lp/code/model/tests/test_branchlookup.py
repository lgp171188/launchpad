...
class TestGetByHostingPath(TestCaseWithFactory):
    ...
    def test_trailing_path(self):
        ...
        result = self.lookup.getByHostingPath(branch.unique_name + "/" + path)
...
class TestLinkedBranchTraverser(TestCaseWithFactory):
    ...
    def test_error_fallthrough_product_series(self):
        ...
        self.assertRaises(NoSuchProduct, self.traverser.traverse, "bb/dd")
    ...
    def test_no_such_distribution(self):
        ...
        # doesn't exist.
        self.assertRaises(
            NoSuchProduct, self.traverser.traverse, "distro/series/package"
        )
...
class TestGetByLPPath(TestCaseWithFactory):
    ...
    def test_private_branch(self):
        ...
        self.assertRaises(NoSuchBranch, self.branch_lookup.getByLPPath, path)
    ...
    def test_resolve_product_branch_unique_name(self):
        ...
        branch = self.factory.makeProductBranch()
        self.assertEqual(
            (branch, ""), self.branch_lookup.getByLPPath(branch.unique_name)
        )
    ...
    def test_resolve_distro_package_branch(self):
        ...
        run_with_login(
            registrant,
            ICanHasLinkedBranch(distro_package).setBranch,
            branch,
            registrant,
        )
        self.assertEqual(
    ...
    def test_no_official_branch(self):
        sourcepackage = self.factory.makeSourcePackage()
        exception = self.assertRaises(
            NoLinkedBranch, self.branch_lookup.getByLPPath, sourcepackage.path
        )
    ...
    def test_distribution_with_no_series(self):
        ...
        self.assertRaises(NoLinkedBranch, self.branch_lookup.getByLPPath, path)
    ...
    def test_too_long_sourcepackage(self):
        ...
        result = self.branch_lookup.getByLPPath("%s/other/bits" % package.path)
        self.assertEqual((branch, "other/bits"), result)

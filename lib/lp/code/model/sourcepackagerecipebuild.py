...
class SourcePackageRecipeBuild(
    ...
    def source_package_release(self):
        ...
        return (
            Store.of(self)
            .find(SourcePackageRelease, source_package_recipe_build=self)
            .one()
        )
    ...
    def getByBuildFarmJob(cls, build_farm_job):
        ...
        return (
            ...
            .find(cls, build_farm_job_id=build_farm_job.id)
            .one()
        )
    ...
    def getByBuildFarmJobs(cls, build_farm_jobs):
        ...
        rows = Store.of(build_farm_jobs[0]).find(
            cls, cls.build_farm_job_id.is_in(bfj.id for bfj in build_farm_jobs)
        )

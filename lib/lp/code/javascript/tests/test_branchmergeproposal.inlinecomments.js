...
YUI.add('lp.code.branchmergeproposal.inlinecomments.test', function (Y) {
    ...
    tests.suite.add(new Y.Test.Case({
        ...
        test_population: function () {
            ...
            var person_obj = {
                ...
                "name": "name16",
                "web_link": "http://launchpad.test/~name16",
                "resource_type_link": "http://launchpad.test/api/devel/#person"
            };
    ...
    tests.suite.add(new Y.Test.Case({
        ...
        setUp: function () {
            // Loads testing values into LP.cache.
            LP.cache.context = {
                web_link: "https://launchpad.test/~foo/bar/foobr/+merge/1",
                self_link: ("https://code.launchpad.test/api/devel/" +
                            "~foo/bar/foobr/+merge/1"),
                preview_diff_link: ("https://code.launchpad.test/api/devel/" +
                                    "~foo/bar/foobr/+merge/1/preview_diff"),
                preview_diffs_collection_link: (
                    "https://code.launchpad.test/api/devel/" +

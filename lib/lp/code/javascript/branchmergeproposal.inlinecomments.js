...
namespace.add_doubleclick_handler = function() {
    ...
    var edit_handler = function(e) {
        ...
        if (namespace.inlinecomments == null) {
    ...
    Y.one('.diff').delegate(
        'click', edit_handler, 'tr[id^="diff-line"] .line-no, tr[id^="diff-line"] .ss-line-no');
    Y.one('.diff').delegate('hover',
        function(e) {
            e.currentTarget.all('.line-no, .ss-line-no').addClass('active');
        },
        function(e) {
            e.currentTarget.all('.line-no, .ss-line-no').removeClass('active');
        },
        'tr[id^="diff-line"]');
};

...
class TestGetAncestry(TestCaseWithTransport):
    ...
    def test_some(self):
        ...
        self.assertEqual({b"A"}, get_ancestry(branch.repository, b"A"))
        self.assertEqual({b"A", b"B"}, get_ancestry(branch.repository, b"B"))
        self.assertEqual(
    ...
    def test_children(self):
        ...
        tree.commit("msg c", rev_id=b"C")
        self.assertEqual({b"A"}, get_ancestry(branch.repository, b"A"))
        self.assertEqual({b"B"}, get_ancestry(branch.repository, b"B"))
        self.assertEqual(
            {b"A", b"B", b"C"}, get_ancestry(branch.repository, b"C")
        )

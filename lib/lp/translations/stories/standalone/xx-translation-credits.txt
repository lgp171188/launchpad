...
This has no translation yet:
    ...
    >>> print(extract_text(
    ...     find_tag_by_id(browser.contents, 'msgset_199_sr_translation_0')))
    (no translation yet)
...
And translation credits now list Carlos.
    ...
    >>> print(extract_text(
    ...     find_tag_by_id(browser.contents, 'msgset_200_sr_translation_0')))
    ,,carlos@canonical.com

    >>> print(extract_text(
    ...     find_tag_by_id(browser.contents, 'msgset_201_sr_translation_0')))

...
class RosettaApplicationView(LaunchpadView, TranslationsMixin):
    ...
    def batchnav(self):
        ...
        return BatchNavigator(products.getTranslatables(), self.request)
...
class RosettaApplicationNavigation(Navigation):
    ...
    def redirect_groups(self):
        ...
        return self.redirectSubTree(target_url + "+groups", status=301)
    ...
    def redirect_imports(self):
        ...
        return self.redirectSubTree(target_url + "+imports", status=301)

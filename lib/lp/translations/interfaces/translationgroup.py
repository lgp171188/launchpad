...
from lp.services.fields import PublicPersonChoice, Summary, Title, URIField
from lp.translations.enums import TranslationPermission


@exported_as_webservice_entry(
    singular_name="translation_group",
    plural_name="translation_groups",
    as_of="beta",
)
class ITranslationGroup(IHasOwner):
    ...
    name = exported(
        TextLine(
            ...
            required=True,
            description=_(
                """Keep this name very short, unique, and
    ...
    title = exported(
        Title(
            ...
            required=True,
            description=_(
                """Title of this Translation Group.
    ...
    summary = Summary(
        ...
        required=True,
        description=_(
            """A single-paragraph description of the
    ...
    products = Attribute(
        "The projects to which this group is directly "
    ...
    translation_guide_url = URIField(
        title=_("Translation instructions"),
        required=False,
        allowed_schemes=["http", "https", "ftp"],
        allow_userinfo=False,
        description=_(
            "The URL of the generic translation instructions "
...
class ITranslationGroupSet(Interface):
    ...
    @operation_parameters(
        name=TextLine(
            title=_("Name of the translation group"),
        )
    )

...
class ITranslationMessage(Interface):
    ...
    def approve(
        pofile, reviewer, share_with_other_side=False, lock_timestamp=None
    ):
    ...
    def acceptFromImport(
        pofile, share_with_other_side=False, lock_timestamp=None
    ):

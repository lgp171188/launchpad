...
class ITranslationHeaderData(Interface):
    ...
    number_plural_forms = Int(title="Number of plural forms.", required=True)
...
class ITranslationMessageData(Interface):
    ...
    context = Text(
        title="The context of the message.", required=True, readonly=True
    )

    msgid_singular = Text(
        title="The singular msgid of the message.",
        required=True,
        readonly=True,
    )

    singular_text = Text(
        title=("The message singular text. Usually matches msgid_singular."),
        required=False,
        readonly=True,
    )
    ...
    plural_text = Text(
        title=("The message plural text. Usually matches msgid_plural."),
        required=False,
        readonly=True,
    )

    translations = List(
        title="The translations of the message.", required=True, readonly=True
    )

    comment = Text(
        title="Comments added by a translator.", required=True, readonly=True
    )
...
class ITranslationFileData(Interface):
    ...
    format = Choice(
        title="This file's translation file format.",
        required=True,
    ...
    is_template = Bool(
        title="Is this entry a translation template?",
        required=True,
        readonly=True,
    )

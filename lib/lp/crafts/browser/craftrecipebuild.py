...
"""Craft recipe build views."""

__all__ = [
    "CraftRecipeBuildContextMenu",
    "CraftRecipeBuildNavigation",
    "CraftRecipeBuildView",
]
...
class CraftRecipeBuildNavigation(Navigation, FileNavigationMixin):
    usedfor = ICraftRecipeBuild


class CraftRecipeBuildContextMenu(ContextMenu):
    """Context menu for craft recipe builds."""
...
class CraftRecipeBuildView(LaunchpadView):
    """Default view of a craft recipe build."""
...
class CraftRecipeBuildRetryView(LaunchpadFormView):
    """View for retrying a craft recipe build."""
...
class CraftRecipeBuildCancelView(LaunchpadFormView):
    """View for cancelling a craft recipe build."""
...
class CraftRecipeBuildRescoreView(LaunchpadFormView):
    """View for rescoring a craft recipe build."""

...
class TestFilesystem(TestCaseWithTransport):
    ...
    def test_remove_branch_directory(self):
        ...
        self.assertRaises(errors.PermissionDenied, transport.rmdir, "foo")
    ...
    def test_make_invalid_user_directory(self):
        ...
        self.assertRaises(errors.PermissionDenied, transport.mkdir, "apple")
    ...
    def test_mkdir_not_team_member_error(self):
        ...
        self.assertRaises(
            errors.PermissionDenied,
            transport.mkdir,
            "~%s/%s/new-branch" % (team.name, product.name),
        )
    ...
    def test_make_team_branch_directory(self):
        ...
        self.assertTrue(
            transport.has("~%s/%s/shiny-new-thing" % (team.name, product.name))
        )
    ...
    def test_get_stacking_policy(self):
        ...
        control_file = transport.get_bytes(
            "~%s/%s/.bzr/control.conf" % (self.requester.name, product.name)
        )
